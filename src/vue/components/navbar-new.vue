...
export default {
  ...
  emits: [
    ...
    'navbar-new:expand',
    'navbar-new:collapse',
    'navbar-new:transparentshow',
    'navbar-new:transparenthide',
    'click:back',
    'back:click',
  ],
  setup(props, { emit, slots }) {
    ...
    const addLeftTitleClass = computed(
      () =>
        ...
        theme.value.ios &&
        f7 &&
        !(f7.params.navbarNew && f7.params.navbarNew.iosCenterTitle),
    );
    ...
    const addCenterTitleClass = computed(
      () =>
        ...
        f7 &&
        f7.params.navbarNew &&
        f7.params.navbarNew.mdCenterTitle,
    );
